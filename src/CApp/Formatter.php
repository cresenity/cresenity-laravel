...
class Formatter
{
    ...
    {
        $this->dateFormat = CF::config('cresenity.app.format.date', CF::config('date_formatted', 'Y-m-d'));
        $this->datetimeFormat = CF::config('cresenity.app.format.datetime', CF::config('long_date_formatted', 'Y-m-d H:i:s'));
        $this->thousandSeparator = CF::config('cresenity.app.format.thousand_separator', '.');
        $this->decimalSeparator = CF::config('cresenity.app.format.decimal_separator', ',');
        $this->decimalDigit = CF::config('cresenity.app.format.decimal_digit', 0);
        $this->currencyDecimalDigit = CF::config('cresenity.app.format.currency_decimal_digit', null);
        $this->currencyPrefix = CF::config('cresenity.app.format.currency_prefix', '');
        $this->currencySuffix = CF::config('cresenity.app.format.currency_suffix', '');
        $this->currencyStripZeroDecimal = CF::config('cresenity.app.format.currency_strip_zero_decimal', false);
    }
