...
use Cresenity\Laravel\CElement\Component\Action;
...
class ActionList extends ElementList
{
    ...
    {
        $this->apply('style', $this->style, [Action::class]);
    }
        ...
        */
        ...
        switch ($this->style) {
            ...
            case 'btn-group-toggle-checkbox':
                $attributes = '';
                if (Str::startsWith($this->style, 'btn-group-toggle')) {
