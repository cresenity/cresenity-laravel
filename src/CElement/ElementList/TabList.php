...
use Cresenity\Laravel\CElement\ElementList;
use Cresenity\Laravel\CElement\ElementList\TabList\Tab;
use Cresenity\Laravel\CStringBuilder;

class TabList extends ElementList
{
    /**
     * Tabs.
     *
     * @var \Cresenity\Laravel\CElement\ElementList\TabList_Tab[]
     */
    protected $tabs;
     ...
     * @param int $id
     *
     * @return \\Cresenity\Laravel\CElement\ElementList\TabList
     */
     ...
     * @param string $id
     *
     * @return \Cresenity\Laravel\CElement\ElementList\TabList\Tab
     */
    public function addTab($id = '')
    {
        $tab = Tab::factory($id)->setTabList($this);
