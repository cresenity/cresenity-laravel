...
use Cresenity\Laravel\CUTF8\Native as CUTF8Native;
...
class CUTF8 {
    ...
    public static function transliterateToAscii($str, $case = 0) {
        return CUTF8Native::transliterateToAscii($str, $case);
    }
    ...
    public static function strpos($str, $search, $offset = 0) {
        ...
        return CUTF8Native::strpos($str, $search, $offset);
    }
    ...
    public static function strrpos($str, $search, $offset = 0) {
        ...
        return CUTF8Native::strrpos($str, $search, $offset);
    }
    ...
    public static function substr($str, $offset, $length = null) {
        ...
        return CUTF8Native::substr($str, $offset, $length);
    }
    ...
    public static function substrReplace($str, $replacement, $offset, $length = null) {
        return CUTF8Native::substrReplace($str, $replacement, $offset, $length);
    }
    ...
    public static function strtolower($str) {
        ...
        return CUTF8Native::strtolower($str);
    }
    ...
    public static function strtoupper($str) {
        ...
        return CUTF8Native::strtoupper($str);
    }
    ...
    public static function ucfirst($str) {
        return CUTF8Native::ucfirst($str);
    }
    ...
    public static function ucwords($str) {
        return CUTF8Native::ucwords($str);
    }
    ...
    public static function strcasecmp($str1, $str2) {
        return CUTF8Native::strcasecmp($str1, $str2);
    }
    ...
    public static function strIreplace($search, $replace, $str, &$count = null) {
        return CUTF8Native::strIreplace($search, $replace, $str, $count);
    }
    ...
    public static function stristr($str, $search) {
        return CUTF8Native::stristr($str, $search);
    }
    ...
    public static function strspn($str, $mask, $offset = null, $length = null) {
        return CUTF8Native::strspn($str, $mask, $offset, $length);
    }
    ...
    public static function strcspn($str, $mask, $offset = null, $length = null) {
        return CUTF8Native::strcspn($str, $mask, $offset, $length);
    }
    ...
    public static function strPad($str, $final_str_length, $pad_str = ' ', $pad_type = STR_PAD_RIGHT) {
        return CUTF8Native::strPad($str, $final_str_length, $pad_str, $pad_type);
    }
    ...
    public static function strSplit($str, $split_length = 1) {
        return CUTF8Native::strSplit($str, $split_length);
    }
    ...
    public static function trim($str, $charlist = null) {
        return CUTF8Native::trim($str, $charlist);
    }
    ...
    public static function ltrim($str, $charlist = null) {
        return CUTF8Native::ltrim($str, $charlist);
    }
    ...
    public static function rtrim($str, $charlist = null) {
        return CUTF8Native::rtrim($str, $charlist);
    }
    ...
    public static function toUnicode($str) {
        return CUTF8Native::toUnicode($str);
    }
    ...
    public static function fromUnicode($arr) {
        return CUTF8Native::fromUnicode($arr);
    }
