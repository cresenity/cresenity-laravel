...
class Precision
{
     ...
     * @return \DateTimeImmutable
     */
    public function ceilDate(\DateTimeInterface $date, Precision $precision)
    {
        list($year, $month, $day, $hour, $minute, $second) = explode(' ', $date->format('Y m d H i s'));
    ...
    /**
     * @param \Cresenity\Laravel\CPeriod\Precision ...$others
     *
     * @return bool
     */
    public function equals(Precision ...$others)
    {
    ...
    /**
     * @param \Cresenity\Laravel\CPeriod\Precision $other
     *
     * @return bool
     */
    public function higherThan(Precision $other)
    {
