...
class Boundaries
{
     ...
     */
    public function realStart(\DateTimeImmutable $includedStart, Precision $precision)
    {
     ...
     * @return DateTimeImmutable
     */
    public function realEnd(\DateTimeImmutable $includedEnd, Precision $precision)
    {
        if ($this->endIncluded()) {
            return $includedEnd;
        }
