...
trait ComparisonTrait
{
    ...
    {
        return $this->includedStart()->getTimestamp() === $this->precision->roundDate($date)->getTimestamp();
    }
    ...
    /**
     * @param \Cresenity\Laravel\CPeriod $period
     *
     * @return bool
     */
    ...
    /**
     * @param DateTimeInterface|\Cresenity\Laravel\CPeriod $other
     *
     * @return bool
     */
