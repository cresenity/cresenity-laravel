<?php
namespace Cresenity\Laravel\CUTF8\Traits;

trait LowerUpperTrait {
    protected static $upperToLower = null;

    protected static $lowerToUpper = null;

    protected static $lowerAccents = null;

    protected static $upperAccents = null;

    protected static function getUpperToLower() {
        if (static::$upperToLower === null) {
            static::$upperToLower = [
        ...
        return static::$upperToLower;
    }

    protected static function getLowerToUpper() {
        if (static::$upperToLower === null) {
            static::$upperToLower = [
    ...
    protected static function getLowerAccents() {
        if (static::$lowerAccents === null) {
            static::$lowerAccents = [
        ...
        return static::$lowerAccents;
    }

    protected static function getUpperAccents() {
        if (static::$upperAccents === null) {
            static::$upperAccents = [
                'À' => 'A',  'Ô' => 'O',  'Ď' => 'D',  'Ḟ' => 'F',  'Ë' => 'E',  'Š' => 'S',  'Ơ' => 'O',
