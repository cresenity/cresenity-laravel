...
final class CManager
{
    ...
    /**
     * @var \Cresenity\Laravel\CManager\Theme
     */
    ...
    {
        return new CManager_DataProvider_ClosureDataProvider($closure, Arr::wrap($requires));
    }
     ...
     */
    public static function createCollectionDataProvider(Collection $collection)
    {
